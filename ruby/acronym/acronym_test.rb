...
class AcronymTest < Minitest::Test
  ...
  def test_genitive
    assert_equal "KIRU", Acronym.abbreviate("Kiru's idea really unifies" )
  end

  def test_underscores
    assert_equal "TTRBTRT", Acronym.abbreviate("This test _really_ brings the room together." )
  end

  def test_unicode
    assert_equal "CTEÉ", Acronym.abbreviate("Cette test est étonnante" )
  end
end
